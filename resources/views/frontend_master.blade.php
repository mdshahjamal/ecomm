    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                ...
                <a href="{{ route('register') }}"><i class="fa fa-register"></i> Sign Up Now</a>
            </div>
        </div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> shahjamalraj@gmail.com</li>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                ...
                                <a href="{{ route('register') }}"><i class="fa fa-user"></i> Sign Up Now</a>
                                @endauth
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: 60-49 Road 11378 Chittagong, Bangladesh</li>
                            <li>Phone: +8801921340146</li>
                            <li>Email: shahjamalraj@gmail.com</li>
                        </ul>
                    </div>
                </div>
